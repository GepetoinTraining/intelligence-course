...
const MOCK_COURSES: Course[] = [
    {
        id: '1',
        name: 'Fundamentos de IA para Jovens',
        description: 'Introdução lúdica à inteligência artificial e prompting para crianças e adolescentes',
        slug: 'ia-jovens',
        targetDemographic: ['kids', 'teens'],
    ...
    {
        id: '2',
        name: 'AI Mastery para Profissionais',
        description: 'Domine técnicas avançadas de prompting para aumentar produtividade no trabalho',
        slug: 'ai-profissionais',
        targetDemographic: ['professionals', 'adults'],
    ...
    {
        id: '3',
        name: 'IA para Educadores',
        description: 'Como integrar IA generativa na sala de aula de forma ética e eficaz',
        slug: 'ia-educadores',
    ...
    {
        id: '4',
        name: 'Programa Intensivo de Verão',
        description: 'Bootcamp de 2 semanas para dominar os fundamentos de prompting',
        slug: 'bootcamp-verao',
        targetDemographic: ['teens', 'adults'],
