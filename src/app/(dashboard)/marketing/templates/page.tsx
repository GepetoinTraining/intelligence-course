...
const MOCK_TEMPLATES: EmailTemplate[] = [
    {
        ...
        subject: '👋 Olá {{nome}}, bem-vindo(a) à [Escola]!',
        category: 'welcome',
        content: `Olá {{nome}}!

Que bom ter você por aqui! 🎉

Ficamos muito felizes com seu interesse em aprender sobre Inteligência Artificial conosco.

O curso {{curso}} é perfeito para quem quer dominar as técnicas mais modernas de prompting e uso de IA no dia-a-dia.

**Próximos passos:**
1. Agende uma aula experimental gratuita
2. Conheça nossa metodologia única
3. Descubra como a IA pode transformar seu futuro

[AGENDAR AULA GRATUITA]({{link_trial}})

Se tiver qualquer dúvida, é só responder este email!

Abraços,
Equipe [Escola]`,
        variables: ['nome', 'curso', 'link_trial'],
        usageCount: 156,
        lastUsed: '2026-02-03',
    },
    {
        id: '2',
        name: 'Lembrete de Trial',
        subject: '⏰ {{nome}}, sua aula experimental é amanhã!',
        category: 'trial',
        content: `Olá {{nome}}!

Estamos ansiosos para te receber amanhã! 🚀
...
- Como conversar com a IA de forma eficaz
- Dicas práticas para usar no dia-a-dia

Prepare suas perguntas e venha com a mente aberta!

Até amanhã,
Equipe [Escola]`,
        variables: ['nome', 'data_trial', 'horario', 'professor'],
        usageCount: 89,
        lastUsed: '2026-02-02',
    },
    {
        id: '3',
        name: 'Oferta Especial pós-Trial',
        subject: '🎁 {{nome}}, sua oferta exclusiva expira em 48h!',
        category: 'enrollment',
        content: `{{nome}}, você arrasou no trial! 🌟

Foi ótimo ter você conosco. Sua participação foi incrível!

Como prometido, aqui está sua **oferta exclusiva**:

💰 **De:** ~~R$ {{preco}}~~
💚 **Por:** R$ {{preco}} - {{desconto}} = **OFERTA ESPECIAL**

⏰ Essa condição é válida apenas por **48 horas**.

[GARANTIR MINHA VAGA]({{link_matricula}})

Não deixe essa oportunidade passar!

Abraços,
Equipe [Escola]`,
        variables: ['nome', 'preco', 'desconto', 'link_matricula'],
        usageCount: 67,
        lastUsed: '2026-02-01',
    },
    {
...
Muita coisa mudou no mundo da IA desde então! ChatGPT, Claude, Gemini... as possibilidades são infinitas.

Que tal retomar de onde paramos?

Preparamos algo especial para você:
🎁 **20% de desconto** na primeira mensalidade
📚 Acesso a materiais exclusivos
🚀 Metodologia atualizada com as últimas novidades

[QUERO SABER MAIS]({{link_trial}})

Ficamos no aguardo!

Abraços,
Equipe [Escola]`,
        variables: ['nome', 'link_trial'],
        usageCount: 34,
        lastUsed: '2026-01-28',
    },
];
