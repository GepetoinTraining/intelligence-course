...
const MOCK_LEADS: Lead[] = [
    {
        ...
        assignedTo: null,
        lastContactAt: Date.now() - 3600000,
        nextFollowupAt: Date.now() + 86400000,
        createdAt: Date.now() - 604800000,
        updatedAt: Date.now() - 3600000,
        insights3x3Complete: true,
    },
    {
        id: '2',
        name: 'João Santos',
        ...
        assignedTo: null,
        lastContactAt: Date.now() - 7200000,
        nextFollowupAt: null,
        createdAt: Date.now() - 1209600000,
        updatedAt: Date.now() - 7200000,
        insights3x3Complete: false,
    },
    {
        id: '3',
        name: 'Ana Costa',
        ...
        assignedTo: null,
        lastContactAt: Date.now() - 1800000,
        nextFollowupAt: Date.now() + 43200000,
    ...
    },
    {
        ...
        personaGeneratedAt: null,
        assignedTo: null,
        lastContactAt: Date.now() - 14400000,
        nextFollowupAt: Date.now() + 21600000,
    ...
    },
    {
        ...
        personaGeneratedAt: null,
        assignedTo: null,
        lastContactAt: Date.now() - 259200000,
        nextFollowupAt: null,
        createdAt: Date.now() - 604800000,
