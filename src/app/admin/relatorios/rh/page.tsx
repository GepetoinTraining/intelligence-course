            ...
            <Stack gap="lg">
                <div>
                    <Group gap="xs" mb={4}>
                        ...
                        <Text size="sm" fw={500}>Relatório RH</Text>
                    </Group>
                    <Group gap="md" align="center">
                        <Title order={1}>Relatório RH</Title>
                        <Badge variant="light" color="yellow" size="sm">Em Construção</Badge>
                    </Group>
                    <Text c="dimmed" mt="xs">Indicadores de RH: turnover, absenteísmo e satisfação dos colaboradores.</Text>
                </div>
