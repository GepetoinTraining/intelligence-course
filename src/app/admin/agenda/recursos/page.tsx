            ...
            <Stack gap="lg">
                <div>
                    <Group gap="xs" mb={4}>
                        ...
                        <Text size="sm" fw={500}>Recursos</Text>
                    </Group>
                    <Group gap="md" align="center">
                        <Title order={1}>Recursos</Title>
                        <Badge variant="light" color="yellow" size="sm">Em Construção</Badge>
                    </Group>
                    <Text c="dimmed" mt="xs">Gerencie a alocação de recursos físicos como projetores, equipamentos e materiais.</Text>
                </div>
