            ...
            <Stack gap="lg">
                <div>
                    <Group gap="xs" mb={4}>
                        ...
                        <Text size="sm" fw={500}>Quadro de Ideias</Text>
                    </Group>
                    <Group gap="md" align="center">
                        <Title order={1}>Quadro de Ideias</Title>
                        <Badge variant="light" color="yellow" size="sm">Em Construção</Badge>
                    </Group>
                    <Text c="dimmed" mt="xs">Kanban de ideias e sugestões de melhoria contínua.</Text>
                </div>
