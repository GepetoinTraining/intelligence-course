            ...
            <Stack gap="lg">
                <div>
                    <Group gap="xs" mb={4}>
                        ...
                        <Text size="sm" fw={500}>Pesquisas</Text>
                    </Group>
                    <Group gap="md" align="center">
                        <Title order={1}>Pesquisas</Title>
                        <Badge variant="light" color="yellow" size="sm">Em Construção</Badge>
                    </Group>
                    <Text c="dimmed" mt="xs">Crie e gerencie pesquisas de satisfação e clima organizacional.</Text>
                </div>
