            ...
            <Stack gap="lg">
                <div>
                    <Group gap="xs" mb={4}>
                        ...
                        <Text size="sm" fw={500}>Análises IA</Text>
                    </Group>
                    <Group gap="md" align="center">
                        <Title order={1}>Análises IA</Title>
                        <Badge variant="light" color="yellow" size="sm">Em Construção</Badge>
                    </Group>
                    <Text c="dimmed" mt="xs">Análises preditivas e insights gerados por inteligência artificial.</Text>
                </div>
