            ...
            <Stack gap="lg">
                <div>
                    <Group gap="xs" mb={4}>
                        ...
                        <Text size="sm" fw={500}>Uso & Custos</Text>
                    </Group>
                    <Group gap="md" align="center">
                        <Title order={1}>Uso & Custos</Title>
                        <Badge variant="light" color="yellow" size="sm">Em Construção</Badge>
                    </Group>
                    <Text c="dimmed" mt="xs">Monitore o consumo e custos de tokens de IA da sua instituição.</Text>
                </div>
