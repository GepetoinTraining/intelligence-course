            ...
            <Stack gap="lg">
                <div>
                    <Group gap="xs" mb={4}>
                        ...
                        <Text size="sm" fw={500}>Geradores IA</Text>
                    </Group>
                    <Group gap="md" align="center">
                        <Title order={1}>Geradores IA</Title>
                        <Badge variant="light" color="yellow" size="sm">Em Construção</Badge>
                    </Group>
                    <Text c="dimmed" mt="xs">Geradores automáticos de conteúdo, relatórios e documentos com IA.</Text>
                </div>
